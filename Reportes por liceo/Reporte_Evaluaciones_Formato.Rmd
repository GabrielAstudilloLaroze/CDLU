...
subtitle: Instituto Comerial Eliodoro Domínguez.
output:
  pdf_document:
    toc: yes
---
...
colegio<-"Instituto Comercial Eliodoro Domínguez"
...
``` {R echo=FALSE, include = FALSE}
bd_fd<-col%>%
  filter(Nivel == "III", `Asignatura o módulo` ==  "APLICACIONES INFORMÁTICAS PARA LA GESTIÓN ADMINISTRATIVA" | 
...
library(stringr)     
pr_fd$`Asignatura o módulo`<-str_replace_all(pr_fd$`Asignatura o módulo`, "APLICACIONES INFORMÁTICAS PARA LA GESTIÓN ADMINISTRATIVA", "AIGA")
...
pr_fd$`Asignatura o módulo`<-str_replace_all(pr_fd$`Asignatura o módulo`, "REGISTRO DE OPERACIONES DE COMERCIO NACIONAL E INTERNACIONAL", "ROCNI")

pr_fd$`Asignatura o módulo`<-str_replace_all(pr_fd$`Asignatura o módulo`, "Elaboración de Informes Contables y Financieros Cuarto Medio", "Elaboración de Informes Contables y Financieros")
pr_fd$`Asignatura o módulo`<-str_replace_all(pr_fd$`Asignatura o módulo`, "CÁLCULO DE REMUNERACIONES - FINIQUITOS Y OBLIGACIONES LABORALES", "CRFOL")
